...
var (
	...
	publicUserIdPrefix     = ":public:user:id:"
	publicUserMobilePrefix = ":public:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	publicUserIdKey := fmt.Sprintf("%s%v", publicUserIdPrefix, id)
	publicUserMobileKey := fmt.Sprintf("%s%v", publicUserMobilePrefix, data.Mobile)
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	publicUserMobileKey := fmt.Sprintf("%s%v", publicUserMobilePrefix, mobile)
	var resp User
...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	publicUserIdKey := fmt.Sprintf("%s%v", publicUserIdPrefix, data.Id)
	publicUserMobileKey := fmt.Sprintf("%s%v", publicUserMobilePrefix, data.Mobile)
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", publicUserIdPrefix, primary)
}
