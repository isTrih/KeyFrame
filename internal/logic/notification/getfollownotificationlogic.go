...
type GetFollowNotificationLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetFollowNotificationLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetFollowNotificationLogic {
	return &GetFollowNotificationLogic{
...
func (l *GetFollowNotificationLogic) GetFollowNotification(req *types.GetNotificationRequest) (resp *types.GetNotificationResponse, err error) {
	// 从JWT中获取用户ID
