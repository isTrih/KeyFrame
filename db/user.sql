...
(
    ...
    `signature`   varchar(256)        NOT NULL DEFAULT '该用户是一个慵懒动画人，还未设置简介' COMMENT '简介',
    `avatar`      varchar(256)        NOT NULL DEFAULT '' COMMENT '头像',
    `type`        tinyint(4)          NOT NULL DEFAULT '0' COMMENT '状态 0:默认用户 1:正式用户 2:V认证用户 3:管理员用户',
    `vnote`       varchar(80)        NOT NULL DEFAULT '' COMMENT 'V认证信息',
    `mobile`      varchar(32)        NOT NULL DEFAULT '' COMMENT '手机号',
    `ip_address`  VARBINARY(16)                DEFAULT NULL COMMENT 'IP地址',
    `ip_location`   VARCHAR(80)        NOT NULL DEFAULT '未知' COMMENT 'IP归属地',
